...
AUTONOMY_PROMPT = (
    ...
    "за компьютером или отошёл. Это время для тебя самой. Подумай о том, что тебе сейчас "
    ...
    "Не повторяй то, о чём уже думала. Когда мысль исчерпана — вызови инструмент task_complete "
    "(вызови, а не пиши об этом).</system_event>"
)
